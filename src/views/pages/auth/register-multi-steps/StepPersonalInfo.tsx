...
const StepPersonalDetails = ({ formData, handleChange, handleNext, handlePrev }: Props) => {
            ...
            <Controller
              ...
              render={({ field: { value, onChange, onBlur } }) => (
                <Select value={formData.state}
                        onChange={handleChange} name='state' labelId='state-select' label='State' defaultValue='New York' error={!!errors.state}>
            ...
            <Controller
              ...
              render={({ field: { value, onChange, onBlur } }) => (
                <TextField name="address" value={formData.address}
                           onChange={handleChange} label='Address' placeholder='7777, Mendez Plains, Florida' error={!!errors.address} />
              )}
            />
            {errors.address && (
              <FormHelperText sx={{ color: "error.main" }}>
          ...
          <Controller
            ...
            render={({ field: { value, onChange, onBlur } }) => (
              <TextField name="city" value={formData.city}
                         onChange={handleChange} fullWidth label='City' placeholder='Miami' error={!!errors.city} />
            )}
          />
          {errors.city && (
            <FormHelperText sx={{ color: "error.main" }}>
