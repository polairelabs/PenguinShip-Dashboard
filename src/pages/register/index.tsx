...
const Register = () => {
  ...
  const onSubmit = (data: FormData) => {
    ...
    register({ email, firstName, lastName, password }, err => {
      if (err.email) {
        setError('email', {
          type: 'manual',
          message: err.email
      ...
      <RightWrapper sx={skin === 'bordered' && !hidden ? { borderLeft: `1px solid ${theme.palette.divider}` } : {}}>
        ...
        >
          <BoxWrapper>
            ...
            <Box sx={{ mb: 6 }}>
              <TypographyStyled variant='h5'>Affordable shipping starts here 🚀</TypographyStyled>
              <Typography variant='body2'>Make shipping easy and fun!</Typography>
            </Box>
